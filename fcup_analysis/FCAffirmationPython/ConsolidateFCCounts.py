...
good_abrun_list = open('/u/home/bclary/eg1analysis/SKIMprotocol/analysiscode_v2.2/fcup_analysis/principleFCtxtfiles/rates_good_ab.list','r')
fc_rationom_list = glob.glob('/u/home/bclary/eg1analysis/SKIMprotocol/analysiscode_v2.2/fcup_analysis/FCFiles.txt')
good_fcrationom_list = open('/u/home/bclary/eg1analysis/SKIMprotocol/analysiscode_v2.2/fcup_analysis/principleFCtxtfiles/FCGoodFile.txt','r')
...
for line in good_fcrationom_list:
    ...
    #ADDITIONAL STATEMENT TO INCLUDE ROOT22 FILES WITHOUT A FC FILE. PURPOSE IS TO MATCH BISELLIS RESULTS
    if not os.path.exists(fcnom_path):
        fc0 = '0'
        fc1 = '0'
        print 'INSERT INTO [BiselliFileWithFC] ([BiselliFileID], [FC0], [FC1]) VALUES (' + rootfile + ", " + fc0 + ", " +fc1 +");"
    elif os.path.exists(fcnom_path):
