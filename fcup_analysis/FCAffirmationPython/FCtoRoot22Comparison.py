...
##   Printed output is redirected to desired output file.
##   This was reasponsible for creating the main FC root file list
##   that was put into the eg1rundatabasecopy.sql file.
##
###################################
import glob
import os
